...
// NOTE: this single root dynamic segment serves BOTH brand pages and articles.
// Next.js forbids two differently-named dynamic segments at one position, and
// both live at the URL root, so the slug is resolved to a brand or an article
// here. Slug uniqueness is enforced across both tables at write time.
...
export async function generateStaticParams() {
  ...
  return [...brandRows, ...articleRows].map((r) => ({ 'brand-slug': r.slug }));
}
